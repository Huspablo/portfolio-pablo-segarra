...
export const I18N = {
  es: {
    ...
    'skills.lead': 'Del wireframe en Figma al componente en producción. Trabajo tanto en el lado del diseño como en el del código, y eso se nota en cómo enfoco cada proyecto.',
  ...
  en: {
    ...
    'hero.role1': 'Front-End Engineer',
    'hero.role2': 'UI / UX Designer',
    'hero.lead': 'I design and build interfaces with Vue 3. I care deeply about how things look, how they work, and making sure they work for everyone.',
    ...
    'skills.lead': "From Figma wireframe to production component. I work on both the design and the code side, and that shows in how I approach every project.",
    'skills.g1': 'Frontend & Frameworks',
...
export const EXPERIENCE = [
  ...
  },
  {
    ...
    desc: {
      es: 'Trabajé sobre proyectos .NET con Razor haciendo la parte de interfaz con Vue 3, TailwindCSS y Vuetify. Una parte importante del trabajo era Figma: validar los diseños con el equipo y luego llevarlos a código sin que nada se perdiera por el camino. También bastante trabajo de componentes, debugging y puesta a punto de estilos.',
      en: 'Worked on .NET Razor projects handling the front-end with Vue 3, TailwindCSS and Vuetify. A big part of the job was Figma: validating designs with the team and then making sure nothing got lost in translation to code. Lots of component work, debugging and keeping styles consistent too.',
    },
  ...
  },
  {
    ...
    desc: {
      es: 'Proyectos grandes de front-end para Mercadona, Banc Sabadell, Resolution Life y Quirónsalud. Librerías de componentes, sistemas de temas, accesibilidad. Con el tiempo acabé formando a compañeros junior que se fueron incorporando. Bastante variedad: maquetación, algo de back-end, Jira, SCRUM — de todo.',
      en: 'Big front-end projects for Mercadona, Banc Sabadell, Resolution Life and Quirónsalud. Component libraries, theming systems, accessibility. Over time I ended up training junior colleagues as they joined. Good variety: layout, some back-end, Jira, SCRUM — the full picture.',
    },
  ...
  },
  {
    ...
    desc: {
      es: 'Mis primeras prácticas, en OutSystems. Maquetación HTML, CSS y JavaScript, comprobar que todo se viera bien en distintos dispositivos, gestión de temas y algún reporte de front para el equipo. El comienzo de todo.',
      en: 'My first internship, at OutSystems. HTML, CSS and JavaScript coding, making sure everything looked right across devices, theme management and some front-end reporting. Where it all started.',
    },
  ...
  },
  {
    ...
    desc: {
      es: 'Prácticas universitarias de marketing digital: redes sociales, campañas, algo de SEO y SEM y los reportes de rigor. Fue antes de decidirme del todo por el desarrollo, pero me vino bien entender el lado de comunicación y estrategia.',
      en: 'University marketing internship: social media, campaigns, some SEO and SEM and the usual reporting. Before going all-in on development, but useful for understanding the communication and strategy side of things.',
    },
